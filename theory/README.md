...
**Step 2 — pressure** (`04_pressure_tank.md`, planned): pressure as the scalar
field whose Laplacian (this verified `L`) enforces `∇·u = 0`, with a closed tank
as the first exact test. Built on the same `L`.
